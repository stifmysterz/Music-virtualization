 ...
 *
 * 顺带守住接线：48 个都注册进 BG3D_BUILDERS 了，但一个都不许漏进 BG3D_CATALOG
...
const KINDS = ['vjLiquidGrid','vjHexPulse','vjNeonRibbon','vjPrismShards','vjWaveCorridor',
               ...
               'vjVoxelPulseTerrain','vjNeonGeometryTunnel','vjBlackGoldFluid'];
...
test('48 个 VJ 都注册好了，而且一个都没漏进 🌌 3D 菜单', async () => {
...
test('跑满一整个循环之后画面还在 —— 元素没有飞光，也没有堆到一处', async () => {
  /* 48 条 VJ × 450 帧，这套里最重的一条。原本 180 秒的预算只剩三分之一余量，
